...
header .fa-times {
  ...
  <body>
    <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" style="background-color: #0188df;">
  ...
  <div class="container">
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-dark" name="submit" type="submit" id="myBtn"  onclick="alert('Transaction Successful');">Transfer</button>
            </div>
        </form>
    </div>
<!-- End Table -->
